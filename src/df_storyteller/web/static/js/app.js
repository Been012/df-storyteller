...
const PIN_TYPE_URLS = { figure: '/lore/figure/', civilization: '/lore/civ/', entity: '/lore/civ/', site: '/lore/site/', artifact: '/lore/artifact/', war: '/lore/war/', battle: '/lore/war/', duel: '/lore/event/', purge: '/lore/event/', beast_attack: '/lore/event/', abduction: '/lore/event/', theft: '/lore/event/', persecution: '/lore/event/', site_conquest: '/lore/event/', overthrow: '/lore/event/', insurrection: '/lore/event/', written_work: '/lore/work/', festival: '/lore/festival/', form_poetic: '/lore/form/poetic/', form_musical: '/lore/form/musical/', form_dance: '/lore/form/dance/', cultural_form: '/lore/form/poetic/', region: '/lore/region/', geography: '/lore/region/', landmass: '/lore/landmass/', peak: '/lore/peak/', construction: '/lore/construction/' };
